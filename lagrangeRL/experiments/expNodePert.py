...
class expNodePert(object):
    ...
    def initLogging(self):
        ...
        self.logger = logging.getLogger('expNodePert')
    ...
    def setUpNetwork(self):
        ...
        # Lagrange network
        self.simClass = lagrangeRL.network.lagrangeTfNodePert()
    ...
    def singleIteration(self, index=0):
        ...
        classwiseR = [self.avgRArrays[key][-1] for key 
                        in self.avgRArrays]
        self.logger.info("The current classwise mean reward is: {}".format(classwiseR))
